...
def create_power_tab():
    ...
    data = [
        ...
        (
            ...
            382.00,
            "75°C",
            "Оптимизированный для Ryzen",
        ),
        (
            "Chrometastic's AMD Extreme",
            30.75,
            24.70,
            36.90,
            383.00,
        ...
        (
            "Tom's AMD Power Plan",
            31.00,
            25.00,
            37.50,
            378.00,
            "73°C",
            "Оптимизированный для AMD",
        ),
        (
            "Tom's Intel Power Plan",
            31.10,
            25.10,
            37.60,
            376.00,
            "72°C",
            "Оптимизированный для Intel",
        ),
        (
            "ReviOS Ultra Performance",
            30.80,
            24.75,
            36.85,
            381.00,
        ...
        (
            ...
            381.50,
            "75°C",
            "Максимальная производительность для Ryzen",
        ),
        (
            ...
            370.00,
            "70°C",
            "Энергоэффективный план для Ryzen",
        ),
        (
            ...
            378.00,
            "73°C",
            "Оптимизированный для отзывчивости",
        ),
        (
        ...
        (
            ...
            380.00,
            "74°C",
            "Максимальная производительность для Intel",
        ),
        (
        ...
        (
            "Catto PowerPlan Win10",
            30.90,
            24.80,
            37.00,
            381.00,
            "74°C",
            "Оптимизированный для Windows 10",
        ),
        (
            "Catto PowerPlan Win7",
            31.00,
            25.00,
            37.20,
            379.00,
            "73°C",
            "Оптимизированный для Windows 7",
        ),
        (
            "DANSKE POWER PLAN",
            30.95,
        ...
        (
            "KernelOS Performance",
            30.90,
            24.80,
            37.00,
            381.00,
            "74°C",
            "Оптимизированный для ядра",
        ),
        (
            "Legion Performance",
            30.95,
            ...
            380.50,
            "74°C",
            "Оптимизированный для ноутбуков",
        ),
        (
            "Phantom Power Plan",
            30.85,
        ...
        (
            "Kirby Powerplan v1.2",
            30.85,
            24.75,
            36.95,
            381.50,
            "75°C",
            "Улучшенная версия v1.1",
        ),
        (
            "Laptop Power Plan",
            31.10,
        ...
        (
            "Revision Power Plan V2.9",
            30.85,
            24.75,
            36.95,
            381.50,
            "75°C",
            "Улучшенная версия v2.8",
        ),
        (
            "Rock Power Plan",
            30.80,
        ...
        (
            ...
            382.00,
            "75°C",
            "Оптимизированный для Valorant",
        ),
        (
            "Win10GE Maximum Performance",
            30.85,
            24.75,
            36.95,
            381.50,
        ...
        # Еще дополнительные планы
        (
            "AMD Ryzen 3k.x Power Plan v3",
            30.85,
            24.75,
            36.95,
            381.50,
            "75°C",
            "Оптимизированный для Ryzen 3000",
        ),
        ...
        (
            ...
            381.50,
            "75°C",
            "Оптимизированный для Razer",
        ),
        (
            "Ryzen CPUs Balanced LowPower v8",
            31.30,
            25.50,
            38.00,
            370.00,
            "70°C",
            "Энергоэффективный план",
        ),
        (
            "Ryzen CPUs Balanced Snappy v1",
            31.00,
            25.20,
            37.60,
            378.00,
        ...
        (
            "Ryzen CPUs Optimized Power Saver",
            31.40,
            25.60,
            38.20,
            368.00,
            "69°C",
            "Энергосберегающий план",
        ),
        (
            "Ryzen CPUs Ultimate Performance v5",
            30.85,
            24.75,
            36.95,
            381.50,
        ...
        (
            "The World of PC's Nexus LiteOS",
            30.90,
            24.80,
            37.00,
            381.00,
            "74°C",
            "Оптимизированный для LiteOS",
        ),
        ("boost_25", 30.95, 24.85, 37.05, 380.00, "74°C", "25% буст"),
        ("boost_50", 30.90, 24.80, 37.00, 381.00, "74°C", "50% буст"),
        ("boost_zen2_12", 30.85, 24.75, 36.95, 381.50, "75°C", "12% буст для Zen2"),
        ("boost_zen2_16", 30.80, 24.70, 36.90, 382.00, "75°C", "16% буст для Zen2"),
        ("boost_zen2_25", 30.75, 24.65, 36.85, 382.50, "75°C", "25% буст для Zen2"),
        ("boost_zen2_33", 30.70, 24.60, 36.80, 383.00, "76°C", "33% буст для Zen2"),
        ("boost_zen2_50", 30.65, 24.55, 36.75, 383.50, "76°C", "50% буст для Zen2"),
        ...
        (
            "TYT_power_plan_idle_off_gaming_V3",
            30.80,
            24.70,
            36.90,
            382.00,
            "75°C",
            "Игровой режим без простоя",
        ),
        (
            "TYT_power_plan_idle_on_normal_use_V3",
            31.00,
            25.00,
            37.20,
            378.00,
            "73°C",
            "Обычный режим с простоем",
        ),
        (
            "wZak_PowerPlan_v.1",
            30.90,
        ...
        (
            ...
            375.00,
            "72°C",
            "Сбалансированный для ноутбуков",
        ),
        (
            "LegionQuiet",
            31.30,
            ...
            370.00,
            "70°C",
            "Тихий режим для ноутбуков",
        ),
        (
            "JamessJ Plan de energia IDLE OFF",
            30.80,
            24.70,
            36.90,
            382.00,
        ...
        (
            "JamessJ Plan de energia IDLE ON",
            31.00,
            25.00,
            37.20,
            378.00,
        ...
        (
            ...
            375.00,
            "72°C",
            "Улучшенный сбалансированный план",
        ),
        # Новые планы
        (
            "Ahorro de energia",
        ...
        (
            ...
            381.50,
            "75°C",
            "Оптимизированный для AMD с бустом",
        ),
        (
            "Amir Crazy Win10",
            30.90,
            ...
            381.00,
            "74°C",
            "Экстремальный план для Windows 10",
        ),
        (
            "Balanced_1",
            31.00,
            ...
            378.00,
            "73°C",
            "Альтернативный сбалансированный план",
        ),
        (
            "Balance Win10 20H2",
            30.95,
            ...
            380.00,
            "74°C",
            "Оптимизированный для Windows 10 20H2",
        ),
        (
            "Balance DisableBoost",
            31.10,
            25.10,
            37.30,
            376.00,
            "72°C",
            "Сбалансированный без буста",
        ),
        (
            "Clixke IDLE Enabled",
            31.00,
        ...
        (
            "ggOS Desktop Gaming 0.8.13",
            30.90,
            24.80,
            37.00,
            381.00,
            "74°C",
            "Игровой план версии 0.8.13",
        ),
        (
        ...
        (
            "Highest Performance No Idle",
            30.75,
            24.65,
            36.85,
            382.50,
            "75°C",
            "Максимальная производительность без простоя",
        ),
        (
            "HT Idle Enabled",
            31.00,
        ...
        (
            "KernelOS Performance v6 IDLE ON",
            30.85,
            24.75,
            36.95,
            381.50,
        ...
        (
            ...
            375.00,
            "72°C",
            "Высокая производительность для ноутбуков",
        ),
        (
            "Rat Low Latency 1",
            30.75,
